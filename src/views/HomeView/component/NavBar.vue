...
<template>
  <nav class="fixed bg-secondary py-3 lg:py-3 xl:py-4 z-50 w-full">
    <div class="container flex justify-between items-center">
      <!-- Brand Logo -->
      <div class="brand-logo w-16 md:w-24 2xl:w-32">
        <RouterLink to="/">
      ...
      <div class="block md:hidden">
        <span class="icon-hamburger text-white" @click="$emit('toggleMenuSidebar', true)"></span>
      </div>
